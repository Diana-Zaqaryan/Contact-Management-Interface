...
import { AddFormProps, Contact, fieldType } from '../../types/type.ts'
...
function Form({ handleSelectContact, data, contact }: AddFormProps) {
  ...
  let lastIndex: string | number = data.length
    ? (data as Contact[]).sort((a: Contact, b: Contact) => +b.id - +a.id)[0].id
    : 1
